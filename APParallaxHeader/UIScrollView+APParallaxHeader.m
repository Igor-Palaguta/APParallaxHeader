...
- (void)setParallaxHeight:(CGFloat)height {
   if (!self.parallaxView)
      return;
   ...
   BOOL showParallax = [self showsParallax];
   
   [self setShowsParallax: NO];
   ...
   [self setShowsParallax: showParallax];
}

- (CGFloat)parallaxHeight {
   return self.parallaxView.parallaxHeight;
}
